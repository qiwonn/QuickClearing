 ...
 * 轻松载入。  qi.wong
 */
public class LoadingRelaxView extends BRelaxView {
    ...
    public LoadingRelaxView(Context context) {
        super(context);
    }

    public LoadingRelaxView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LoadingRelaxView(Context context, AttributeSet attrs, int defStyleAttr) {
