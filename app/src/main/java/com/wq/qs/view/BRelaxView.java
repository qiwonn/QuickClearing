...
public abstract class BRelaxView extends View {


    public BRelaxView(Context context) {
        this(context, null);
    }

    public BRelaxView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BRelaxView(Context context, AttributeSet attrs, int defStyleAttr) {
